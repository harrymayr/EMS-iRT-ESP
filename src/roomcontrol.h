...
class Roomctrl {
  ...
  private:
    ...
    static constexpr uint32_t SEND_INTERVAL __attribute__ ((aligned (4))) = 60000; // 1 minute
    ...
    static uint32_t rc_time_[HCS] __attribute__ ((aligned (4)));
    static int16_t  remotetemp_[HCS] __attribute__ ((aligned (4)));
};
